...
void setup() {
  ...
  // Asegurar LEDs apagados al arrancar
...
void loop() {
  ...
  // -------- ACTUALIZAR LEDs SEGÚN LOS SENSORES --------
  digitalWrite(LED_S1, s1 ? HIGH : LOW);
  digitalWrite(LED_S2, s2 ? HIGH : LOW);
  digitalWrite(LED_S3, s3 ? HIGH : LOW);
  digitalWrite(LED_S4, s4 ? HIGH : LOW);
